        ...
        <template #header>
            <div class="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <a href="/admin/reports/error-report?download=1" class="inline-flex items-center rounded-xl border border-red-300 px-4 py-2 text-sm font-medium text-red-700 transition hover:bg-red-50">
                        Error Report
                    </a>
                    <a href="/admin/reports/feedback-report?download=1" class="inline-flex items-center rounded-xl border border-emerald-300 px-4 py-2 text-sm font-medium text-emerald-700 transition hover:bg-emerald-50">
                        Feedback Report
                    </a>
                </div>
            </div>
